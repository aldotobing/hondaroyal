...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    const pageTitle = navigation.find(item => item.href === location.pathname)?.name || 'Honda Royal Wiyung';
    document.title = `${pageTitle} | Honda Royal - Dealer Resmi Honda`;
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', `Temukan mobil Honda impian Anda di Honda Royal Wiyung - ${pageTitle}. Dapatkan promo dan layanan terbaik untuk kendaraan Honda Anda.`);
    }
  }, [location]);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:bg-white focus:px-4 focus:py-2 focus:font-bold focus:underline">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Mobil Impian Keluarga Indonesia</p>
                </div>
              </div>
              <p className="text-gray-300 mb-4">
                Dealer Honda terpercaya dengan layanan terbaik untuk keluarga Indonesia. 
                Kami menyediakan berbagai model Honda dengan kualitas premium dan harga terjangkau.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <a 
                    ...
                    className="text-gray-300 hover:text-white transition-colors"
                  >
                    Jl. Royal Residence No.B2 No.1-9 B2 No.1-9, Babatan, Wiyung<br />
